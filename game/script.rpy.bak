...
label end_ask():
    ...
    "It took $500 for them to escape successfully, thanks to assistance from a nonprofit organization called {a=https://dvcontrolaltdelete.org/}Control Alt Delete{/a}"
    ...
    cen "Will you help {a=https://dvcontrolaltdelete.org/donate/}fund someone's escape or part of their escape?{/a}"
